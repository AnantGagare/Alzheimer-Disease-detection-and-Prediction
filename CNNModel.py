...
def main():   #All training code of CNN 

    import numpy as np    #used to Numerical operation such as handling array and mathematical function
    from keras.models import Sequential  #it is model and it allows to build linear stack of layers.
    ...
    basepath="D:/All Code/Project Done/Alzheimer_Disease"
